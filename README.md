...
### We are building the world's richest GTM context graph, in public.

**Richest means deepest, not biggest.** Anyone can buy a hundred million contacts. Nobody has a graph where every node carries who wrote it, which run produced it, the source it came from, the rule that permitted the action, and what it eventually produced. That graph cannot be bought, because it is generated by running.

Today it is small, and the number below is live. That is the point of building in public: you can check.
