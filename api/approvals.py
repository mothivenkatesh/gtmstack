"""
Vercel function - GTMstack harness: approvals.
Core logic lives in api/_approvals.py (and the harness engines it imports), shared
...
handler = make_handler("approvals")
