"""
Vercel function - GTMstack harness: definitions.
Core logic lives in api/_definitions.py (and the harness engines it imports), shared
...
handler = make_handler("definitions")
